...
export const CreateDepositForm = ({ isVisible }: { isVisible: boolean }) => {
  const { data, createDeposit, setFee, setAmount, setValidToTimestamp } =
    useCreateDeposit();
        ...
        >
          ...
          >
            <Card.Body>
              ...
              <Card.Body>
                In order to pay for the service you need to deposit GLM tokens.
                That server will use in name of you to pay providers
